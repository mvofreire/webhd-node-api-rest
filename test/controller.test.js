...
// test('paginaton({ total: 5, activePage: 1 }) should return [1, 2, 3, 4, 5]', () => {
...
// test('paginaton({ total: 6, activePage: 1 }) should return [1, 2, 3, "...", 6]', () => {
...
// test('paginaton({ total: 6, activePage: 2 }) should return [1, 2, 3, "...", 6]', () => {
...
// test('paginaton({ total: 6, activePage: 3 }) should return [1, 2, 3, 4, 5, 6]', () => {
...
// test('paginaton({ total: 6, activePage: 4 }) should return [1, 2, 3, 4, 5, 6]', () => {
...
// test('paginaton({ total: 6, activePage: 5 }) should return [1, "...", 4, 5, 6]', () => {
...
// test('paginaton({ total: 6, activePage: 6 }) should return [1, "..." , 4, 5, 6]', () => {
...
// test('paginaton({ total: 7, activePage: 1 }) should return [1, 2, 3, 4, "...", 7]', () => {
...
// test('paginaton({ total: 7, activePage: 3 }) should return [1, 2, 3, 4, "...", 7]', () => {
...
// test('paginaton({ total: 7, activePage: 4 }) should return [1, 2, 3, 4, 5, 6, 7]', () => {
...
// test('paginaton({ total: 7, activePage: 5 }) should return [1, "...", 4, 5, 6, 7]', () => {
...
// test('paginaton({ total: 7, activePage: 6 }) should return [1, "...", 5, 6, 7]', () => {
...
// test('paginaton({ total: 7, activePage: 7 }) should return [1, "...", 5, 6, 7]', () => {
...
// test('paginaton({ total: 15, activePage: 8 }) should return [1, "...", 7, 8, 9, "...", 15]', () => {
...
// test('paginaton({ total: 15 }) should return [1, 2, 3, "...", 15]', () => {
...
// test('paginaton() should return [1]', () => {
//   const result = [1]

//   expect(pagination()).to.be.deep.equal(result)
// })

// test('paginaton({ total: "abc", activePage: 1 }) should throw an error', () => {
...
// test('paginaton({ total: 10, activePage: "1a" }) should throw an error', () => {
